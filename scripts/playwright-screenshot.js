...
const ROUTES = [
  ...
  { path: "/bien/le-phoenix",         name: "bien-le-phoenix" },
  { path: "/bien/tahiti",             name: "bien-tahiti" },
  { path: "/bien/ange",               name: "bien-ange" },
  { path: "/bien/del-mare",           name: "bien-del-mare" },
  { path: "/bien/pine-trees",         name: "bien-pine-trees" },
  { path: "/bien/californienne",      name: "bien-californienne" },
  { path: "/bien/may-flower",         name: "bien-may-flower" },
  { path: "/bien/calimer",            name: "bien-calimer" },
  { path: "/bien/golf",               name: "bien-golf" },
